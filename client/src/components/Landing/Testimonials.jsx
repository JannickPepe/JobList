    ...
    <div className="mt-20 tracking-wide">
      ...
      <div className="flex flex-wrap justify-center">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 px-4 py-2 hover:scale-110 transition duration-300 delay-100">
            <div className="bg-neutral-900  rounded-md p-6 text-md border hover:bg-slate-800 transition delay-200 duration-200 ease-in-out border-neutral-800 font-thin">
              <p className="text-indigo-400">{testimonial.text}</p>
